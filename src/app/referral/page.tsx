      ...
      {viewMode === "home" && (
        <div className="max-w-md mx-auto space-y-4 p-4 pt-4">
          ...
          <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-2xs space-y-4">
            ...
            <button
              onClick={handleShare}
              className="w-full bg-[#047857] hover:bg-[#065f46] text-white font-semibold text-sm py-3 rounded-xl shadow-sm flex items-center justify-center gap-2 transition-all active:scale-[0.99]"
            >
              <Share2 className="w-4 h-4" /> Share Partner Code
            </button>
          </div>

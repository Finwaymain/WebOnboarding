...
function SmartValueContent() {
  ...
  const actions = [
    ...
    { title: "Add Person", icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />, action: "add_person" },
    ...
    { title: "Payouts", icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />, action: "payouts" },
          ...
          <div className="grid grid-cols-2 gap-4">
            {actions.map((item, idx) => (
              <div 
                ...
                onClick={() => alert(`Navigation to ${item.title} not implemented yet`)}
              >
